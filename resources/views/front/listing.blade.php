                ...
                @if($key === 0)
                    <div class="entity_wrapper">
                        ...
                        <div class="entity_thumb">
                           <img class="img-responsive" src="{{ asset('uploads/post') }}/{{ $post->main_image }}" alt="{{ $post->title }}">
                        </div>
                        <!-- entity_thumb -->
                        ...
                        <div class="col-md-6" style="min-height: 555px;margin-bottom:2%">
                           <div class="category_article_body">
                              <div class="top_article_img">
                                 <img class="img-fluid" src="{{ asset('uploads/post') }}/{{ $post->list_image }}" alt="{{ $post->title }}">
                              </div>
                              <!-- top_article_img -->
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="{{ url('/details') }}/{{ $item->slug }}">
                            <img width="200px" class="media-object" src="{{ asset('uploads/post') }}/{{ $item->thumb_image }}" alt="{{ $item->title }}">
                        </a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                            <a href="{{ url('/details') }}/{{ $item->slug }}" >{{ $item->title }}</a>
                        </h3> <span class="media-date"><a href="#">{{ date( 'j F - Y',strtotime($item->created_at)) }}</a>,  by: <a href="{{ url('/author') }}/{{ $item->user->id }}">{{ $item->user->name }}</a></span>
